...
const mockProducts = [
  {
    title: "Power bank adapter for Fibre / 4G Router",
    slug: "power-bank-adapter-fiber-4g-router",
    description: "Specialized DC 12V Step-up Power Bank Adapter Cable engineered for SLT Fibre Optic Routers and Dialog 4G WiFi Routers. Delivers seamless uninterrupted internet uptime (5 to 6 hours) during power outages using any standard 5V USB power bank. Features intelligent voltage boost regulation to prevent router restarts.",
    ...
    specs: JSON.stringify({
      ...
      "VariantType": "Voltage",
      "Up Time": "5 - 6 Hours",
      "Input Voltage": "5V USB (Type A / Standard Power Bank)",
      "Output Voltage": "12V DC Constant Stabilized Output",
    }),
    supplierLink: "https://fochantdropshipping.com/product/26-power-bank-adapter-fiber-4g-router",
    supplierNotes: "Fochant Dropshipping Supplier - Direct 1-Year Local Replacement Warranty.",
    isFeatured: true,
    isBestSeller: true,
  },
  {
    title: "Brand New Fast Charging Type C Data Cable",
    slug: "fast-charging-type-c-data-cable",
    description: "Premium high-speed USB-A to Type-C fast charging and 480Mbps high-speed data sync cable by Ivon. Reinforced flexible TPE stress-relief neck prevents tearing and splitting over 10,000+ bends. Compatible with all Samsung, Xiaomi, Pixel, and Type-C devices.",
    category: "Mobile Accessories",
    ...
    specs: JSON.stringify({
      ...
      "Dimensions": "7 x 4 x 7 cm",
      "Length": "7 cm",
      "Width": "4 cm",
      "Height": "7 cm",
      "Weight": "4 g",
      "Colors": "White, Black",
      "Max Current": "3.0A Fast Charge Support",
      "Data Transfer Rate": "480 Mbps",
    }),
    supplierLink: "https://fochantdropshipping.com/product/16-brand-new-fast-charging-type-c-data-c",
    supplierNotes: "Fochant Dropshipping Supplier - High conversion low-cost accessory.",
    isFeatured: true,
    isBestSeller: false,
  },
  {
