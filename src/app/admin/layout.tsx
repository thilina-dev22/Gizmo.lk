...
import { LayoutDashboard, Package, ShoppingCart, ArrowLeft, Download, LogOut, MessageSquare, Store } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2.5 sm:py-3.5 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs text-red-400 hover:text-red-300 transition-colors bg-red-950/40 hover:bg-red-950/80 px-2.5 sm:px-3 py-1.5 rounded-lg border border-red-500/30 font-semibold"
