...
import { Download, Eye, FileCheck, CheckCircle2, Truck, RefreshCw, X, ShieldAlert, Package, Printer, ExternalLink, MapPin, Phone, User, Mail } from "lucide-react";
                    ...
                    <tr key={order.id} className="hover:bg-slate-850 transition-colors">
                      ...
                      <td className="p-4">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 bg-slate-950 hover:bg-slate-800 text-cyan-400 px-3 py-1.5 rounded-lg border border-slate-800 font-semibold text-[11px] transition-colors"
                        >
                          ...
                          <td className="p-3">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 relative rounded-lg overflow-hidden bg-slate-900 border border-slate-800 shrink-0">
                                <Image src={mainImg} alt={product.title || "Product"} fill className="object-cover" />
                              </div>
                              <div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-800">
              {selectedOrderDetails.bankSlipUrl ? (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-xs text-cyan-400 font-semibold bg-slate-950 px-3.5 py-2 rounded-xl border border-slate-800 hover:bg-slate-800"
                >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold px-5 py-2 rounded-xl text-xs shadow-md"
              >
