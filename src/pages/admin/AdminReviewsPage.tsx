                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 relative rounded-lg overflow-hidden bg-slate-950 border border-slate-800 shrink-0">
                        <OptimizedImage
                          src={imgs[0] || "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=800&auto=format&fit=crop"}
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    {!rev.isApproved && (
                      <button
                        ...
                        className="flex-1 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-1 shadow transition-colors cursor-pointer"
                      >
